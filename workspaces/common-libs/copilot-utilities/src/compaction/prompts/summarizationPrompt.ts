 ...
 *
 * This is the single source of truth for compaction prompts.
 * Mid-stream compaction injects additional instructions via the
 * `customInstructions` parameter in SummarizationService.summarize(),
 * which appends them as "## Additional Summarization Instructions from User".
 */
