...
export interface CompactionMetadata {
    ...
    /** M07: Path to pre-compaction backup file */
    backupPath?: string;
    /** M07: IDs of generations that were compacted */
...
export interface CompactionOptions {
    ...
    maxRetries?: number;
    /** C09: Project state to include in continuation messages */
    projectState?: ProjectStateContext;
    /** M05: AbortSignal to cancel the summarization LLM call */
    abortSignal?: AbortSignal;
}
...
export interface CompactionEngineConfig {
    ...
    /** M02: Optional — set via setSummarizationCallback() to defer model binding */
